#"python -m streamlit run app.py" in terminal to run the application
...
#animated gif
st.image("https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExZnJoNm1hbHE3ZTM5cWE2dzFwcnRteWFydG00NndzZDJpejh1aWhjdSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/eFvs5iE6a6ntVIRaEN/giphy.gif", caption="Let's predict your salary!")
...
# Load model and Scalar with error handling
try:
    scaler = joblib.load("scaler.pkl")
    model = joblib.load("model.pkl")
except FileNotFoundError:
    st.error("Model files not found! Please ensure 'scaler.pkl' and 'model.pkl' are in the same folder as this app.")
    st.stop()
